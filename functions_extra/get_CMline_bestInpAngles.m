function [minAngle12_1, minAngle12_2] = get_CMline_bestInpAngles(Pj1,Pj2,Angle1,Angle2,Range,Step)
...
for i=[(-Range:Step:Range) + ComAngle1*180/pi]
  ...
  for j=[(-Range:Step:Range) + ComAngle2*180/pi]
    ...
    CMline1 = get_commonline_from_angle(Pj1,i, initX, initY);
    CMline2 = get_commonline_from_angle(Pj2,j, initX, initY);
    
    Err = calcR_norm_YY(CMline1,CMline2);
